...
print_4 = Print("Smugglers Moon", artist_2, "50cm x 52cm", 35, 6, 190)
print_5 = Print("Early Morning Harbour", artist_2, "50cm x 52cm", 35, 6, 200)
print_6 = Print("Cannach", artist_3, "40cm x 60cm", 40, 8, 40)
print_7 = Print("Arnisdale", artist_3, "50cm x 40cm", 40, 8, 105) 
print_8 = Print("View of Five Sisters", artist_3, "70cm x 50xm", 45, 8, 95) 
print_9 = Print("Emerge From Rasaay to the Cuillin Hills", artist_4, "35cm x 55cm", 40, 8, 229)
print_10 = Print("Light and Air", artist_4, "35cm x 55cm", 40, 8, 100)
print_11 = Print("Islands", artist_5, "30cm x 40cm", 30, 6, 109)
print_12 = Print("February IV", artist_6, "30cm x 25cm", 30, 6, 205)
print_13 = Print ("Flower Study IV", artist_6, "22cm x 20cm", 30, 6, 102)
print_14 = Print("The Way through the Weeds", artist_7, "50cm x 50cm", 40, 8, 306)
print_15 = Print("Cow Parsley Sunset", artist_7, "50cm x 45cm", 40, 8, 92)
print_16 = Print("Twilight Flock and Rusty Barns", artist_7, "50cm x 45cm", 40, 8, 222)
